package com.inxparticle.runnerapp.db.other
...
import com.inxparticle.runnerapp.databinding.MarkerViewBinding
...
class CustomMarkerView(
    ...
    var binding:MarkerViewBinding = MarkerViewBinding.inflate(LayoutInflater.from(context), this, true)
